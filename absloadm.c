...
int P_STH()                                       /*  п р о г р а м м а     */
 ...
 {                                                /*команды STH             */
  ...
  bytes[1] = (VR[R1] % 0x10000L) % 0x100;         /*качестве первого оп-да, */
						  /*к виду, принятому в     */
						  /*ЕС ЭВМ                  */
...
int P_OR()                                        /*  п р о г р а м м а     */
 ...
 {                                                /*команды OR              */
  ...
  // OBLZ[BAS_IND + CUR_IND + sm + 3];              /*                        */
						  /*и                       */
  //VR[R1] = ADDR; //VR[R1] | VR[R2];                       /*поразрядное ИЛИ*/
...
int P_NR()                                        /*  п р о г р а м м а     */
 ...
 {                                                /*команды NR              */
  ...
  // OBLZ[BAS_IND + CUR_IND + sm + 3];              /*                        */
						  /*и                       */
  //VR[R1] = ADDR; //VR[R1] & VR[R2];                       /*поразрядное И*/
